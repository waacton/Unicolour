...
public class KnownIctcpTests
{
    ...
    public void Red()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(red, new(0.42785, -0.11574, 0.2788), Tolerance);
    }
    ...
    public void Green()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(green, new(0.53975, -0.28121, -0.04946), Tolerance);
    }
    ...
    public void Blue()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(blue, new(0.35607, 0.26914, -0.16143), Tolerance);
    }
    ...
    public void Black()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(black, new(0.00000, 0.00000, 0.00000), Tolerance);
    }
    ...
    public void White()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(white, new(0.58069, 0.00000, 0.00000), Tolerance);
    }
}