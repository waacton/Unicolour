...
public class SmokeTests
{
    ...
    [
        ...
        new(ColourSpace.Lms, 0, 0, 0, 0),
        new(ColourSpace.Lms, 1, 1, 1, 1),
        new(ColourSpace.Lms, 0.4, 0.5, 0.6, 0.5),
        ...
        new(ColourSpace.Oklrab, 0, -0.5, -0.5, 0),
        new(ColourSpace.Oklrab, 1, 0.5, 0.5, 1),
        new(ColourSpace.Oklrab, 0.5, -0.001, 0.001, 0.5),
        new(ColourSpace.Oklrch, 0, 0, 0, 0),
        new(ColourSpace.Oklrch, 1, 0.5, 360, 1),
        new(ColourSpace.Oklrch, 0.5, 0.25, 180, 0.5),
