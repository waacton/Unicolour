...
public record Lchuv
{
    ...
    public Lchuv(double l, double c, double h) : this(l, c, h, true, false) {}
    internal Lchuv(double l, double c, double h, bool hasExplicitHue, bool convertedFromMonochrome)
    {
        L = l;
        C = c;
        H = h;
