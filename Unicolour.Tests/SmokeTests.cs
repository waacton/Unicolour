...
public static class SmokeTests
{
    ...
    public static void UnicolourIctcp(double i, double ct, double cp) => AssertInit(i, ct, cp, Unicolour.FromIctcp, Unicolour.FromIctcp, Unicolour.FromIctcp, Unicolour.FromIctcp);
