...
public class KnownHctTests
{
    ...
    {
        var whiteD65 = new Unicolour(new Configuration(xyzConfig: XyzConfiguration.D65), ColourSpace.Rgb, 1.0, 1.0, 1.0);
    ...
    {
        var whiteD65 = new Unicolour(new Configuration(xyzConfig: XyzConfiguration.D65), ColourSpace.Hct, 209.492, 2.869, 100.000);
    ...
    {
        var whiteD50 = new Unicolour(new Configuration(xyzConfig: XyzConfiguration.D50), ColourSpace.Rgb, 1.0, 1.0, 1.0);
    ...
    {
        var whiteD50 = new Unicolour(new Configuration(xyzConfig: XyzConfiguration.D50), ColourSpace.Hct, 209.492, 2.869, 100.000);
    ...
    public void WhiteEqualEnergyToHct()
    {
        ...
        var whiteE = new Unicolour(new Configuration(xyzConfig: equalEnergyConfig), ColourSpace.Rgb, 1.0, 1.0, 1.0);
    ...
    {
        var equalEnergyConfig = new XyzConfiguration(Illuminant.E, Observer.Degree2);
        var whiteE = new Unicolour(new Configuration(xyzConfig: equalEnergyConfig), ColourSpace.Hct, 209.492, 2.869, 100.000);
