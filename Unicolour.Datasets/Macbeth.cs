...
public static class Macbeth
{
    ...
    public static readonly IEnumerable<Unicolour> Natural = [DarkSkin, LightSkin, BlueSky, Foliage, BlueFlower, BluishGreen];
    public static readonly IEnumerable<Unicolour> Miscellaneous = [Orange, PurplishBlue, ModerateRed, Purple, YellowGreen, OrangeYellow];
    public static readonly IEnumerable<Unicolour> PrimaryAndSecondary = [Blue, Green, Red, Yellow, Magenta, Cyan];
    public static readonly IEnumerable<Unicolour> Greyscale = [White, Neutral8, Neutral65, Neutral5, Neutral35, Black];
