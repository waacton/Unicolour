...
public class MixHctTests
{
    ...
    public void SameColour()
    {
        ...
        var mixed1 = unicolour1.MixHct(unicolour2, 0.25);
        var mixed2 = unicolour2.MixHct(unicolour1, 0.75);
        var mixed3 = unicolour1.MixHct(unicolour2, 0.75);
        var mixed4 = unicolour2.MixHct(unicolour1, 0.25);
    ...
    public void Equidistant()
    {
        ...
        var mixed1 = unicolour1.MixHct(unicolour2, 0.5);
        var mixed2 = unicolour2.MixHct(unicolour1, 0.5);
    ...
    public void CloserToStartColour()
    {
        ...
        var unicolour2 = Unicolour.FromHct(180, 0, 100, 0.5);
        var mixed1 = unicolour1.MixHct(unicolour2, 0.25);
        var mixed2 = unicolour2.MixHct(unicolour1, 0.25);
    ...
    public void BeyondEndColour()
    {
        ...
        var mixed1 = unicolour1.MixHct(unicolour2, 1.5);
        var mixed2 = unicolour2.MixHct(unicolour1, 1.5);
