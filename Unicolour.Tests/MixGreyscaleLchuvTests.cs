...
public class MixGreyscaleLchuvTests
{
    ...
    public void GreyscaleStartColour()
    {
        ...
        var fromLuvBlack = luvBlack.Mix(green, ColourSpace.Lchuv, premultiplyAlpha: false);
        var fromLuvWhite = luvWhite.Mix(green, ColourSpace.Lchuv, premultiplyAlpha: false);
        var fromLchuvBlack = lchuvBlack.Mix(green, ColourSpace.Lchuv, premultiplyAlpha: false);
        var fromLchuvWhite = lchuvWhite.Mix(green, ColourSpace.Lchuv, premultiplyAlpha: false);
    ...
    public void GreyscaleEndColour()
    {
        ...
        var toLuvBlack = blue.Mix(luvBlack, ColourSpace.Lchuv, premultiplyAlpha: false);
        var toLuvWhite = blue.Mix(luvWhite, ColourSpace.Lchuv, premultiplyAlpha: false);
        var toLchuvBlack = blue.Mix(lchuvBlack, ColourSpace.Lchuv, premultiplyAlpha: false);
        var toLchuvWhite = blue.Mix(lchuvWhite, ColourSpace.Lchuv, premultiplyAlpha: false);
    ...
    public void GreyscaleBothLuvColours()
    {
        ...
        var blackToWhite = black.Mix(white, ColourSpace.Lchuv, premultiplyAlpha: false);
        var blackToGrey = black.Mix(grey, ColourSpace.Lchuv, premultiplyAlpha: false);
        var whiteToGrey = white.Mix(grey, ColourSpace.Lchuv, premultiplyAlpha: false);
