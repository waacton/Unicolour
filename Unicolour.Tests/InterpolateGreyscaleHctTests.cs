...
public class InterpolateGreyscaleHctTests
{
    ...
    public void GreyscaleStartColour()
    {
        ...
        var hctBlack = Unicolour.FromHct(180, 100, 0); // no tone = black
        var hctWhite = Unicolour.FromHct(180, 100, 100); // full tone = white
        
        var green = Unicolour.FromHct(120, 100, 50);
        var fromRgbBlack = rgbBlack.InterpolateHct(green, 0.5);
        var fromRgbWhite = rgbWhite.InterpolateHct(green, 0.5);
        var fromHctBlack = hctBlack.InterpolateHct(green, 0.5);
        var fromHctWhite = hctWhite.InterpolateHct(green, 0.5);
    ...
    public void GreyscaleEndColour()
    {
        ...
        var toRgbBlack = blue.InterpolateHct(rgbBlack, 0.5);
        var toRgbWhite = blue.InterpolateHct(rgbWhite, 0.5);
        var toHctBlack = blue.InterpolateHct(hctBlack, 0.5);
        var toHctWhite = blue.InterpolateHct(hctWhite, 0.5);
    ...
    public void GreyscaleBothRgbColours()
    {
        ...
        var blackToWhite = black.InterpolateHct(white, 0.5);
        var blackToGrey = black.InterpolateHct(grey, 0.5);
        var whiteToGrey = white.InterpolateHct(grey, 0.5);
    ...
    {
        var black = Unicolour.FromHct(0, 0, 0);
