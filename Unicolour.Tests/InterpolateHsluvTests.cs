...
public class InterpolateHsluvTests
{
    [Test]
    public void SameColour()
    {
        ...
        var interpolated1 = unicolour1.InterpolateHsluv(unicolour2, 0.25);
        ...
        var interpolated4 = unicolour2.InterpolateHsluv(unicolour1, 0.25);
    ...
    public void Equidistant()
    {
        ...
        var interpolated1 = unicolour1.InterpolateHsluv(unicolour2, 0.5);
        var interpolated2 = unicolour2.InterpolateHsluv(unicolour1, 0.5);
    ...
    public void CloserToEndColour()
    {
        ...
        var interpolated1 = unicolour1.InterpolateHsluv(unicolour2, 0.75);
        var interpolated2 = unicolour2.InterpolateHsluv(unicolour1, 0.75);
    ...
    public void CloserToStartColour()
    {
        ...
        var unicolour2 = Unicolour.FromHsluv(180, 0, 100, 0.5);
        var interpolated1 = unicolour1.InterpolateHsluv(unicolour2, 0.25);
        var interpolated2 = unicolour2.InterpolateHsluv(unicolour1, 0.25);
    ...
    public void BeyondEndColour()
    {
        ...
        var interpolated1 = unicolour1.InterpolateHsluv(unicolour2, 1.5);
        var interpolated2 = unicolour2.InterpolateHsluv(unicolour1, 1.5);
    ...
    {
        AssertUtils.AssertInterpolated(unicolour.Hsluv.Triplet, unicolour.Alpha.A, expected);
    }
}