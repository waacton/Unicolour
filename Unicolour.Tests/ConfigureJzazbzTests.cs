...
public class ConfigureJzazbzTests
{
    ...
    {
        var unicolour = new Unicolour(ColourSpace.Xyz, Config1, TestXyz.Tuple);
    ...
    {
        var unicolour = new Unicolour(ColourSpace.Xyz, Config203, TestXyz.Tuple);
    ...
    {
        var initial100 = new Unicolour(ColourSpace.Xyz, Config100, TestXyz.Tuple);
