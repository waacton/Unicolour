...
public class InterpolateJzczhzTests
{
    ...
    {
        var actualJzczhz = unicolour.Jzczhz;
        var actualAlpha = unicolour.Alpha;
        
        Assert.That(actualJzczhz.J, Is.EqualTo(expected.l).Within(0.00000000005));
        Assert.That(actualJzczhz.C, Is.EqualTo(expected.c).Within(0.00000000005));
        Assert.That(actualJzczhz.H, Is.EqualTo(expected.h).Within(0.00000000005));
