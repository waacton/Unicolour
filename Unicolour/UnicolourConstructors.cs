...
public partial class Unicolour
{
    ...
    public Unicolour(ColourSpace colourSpace, Configuration config, (double first, double second, double third) tuple, double alpha = 1.0) :
        this(colourSpace, config, tuple.first, tuple.second, tuple.third, alpha)
    {
    }
    
    public Unicolour(ColourSpace colourSpace, Configuration config, (double first, double second, double third, double alpha) tuple) :
        this(colourSpace, config, tuple.first, tuple.second, tuple.third, tuple.alpha)
    {
    }

    public Unicolour(ColourSpace colourSpace, Configuration config, double first, double second, double third, double alpha = 1.0) :
