...
public class MixGreyscaleHsbTests
{
    ...
    public void GreyscaleStartColour()
    {
        ...
        var fromRgbBlack = rgbBlack.Mix(green, ColourSpace.Hsb, premultiplyAlpha: false);
        var fromRgbWhite = rgbWhite.Mix(green, ColourSpace.Hsb, premultiplyAlpha: false);
        var fromHsbBlack = hsbBlack.Mix(green, ColourSpace.Hsb, premultiplyAlpha: false);
        var fromHsbWhite = hsbWhite.Mix(green, ColourSpace.Hsb, premultiplyAlpha: false);
    ...
    public void GreyscaleEndColour()
    {
        ...
        var toRgbBlack = blue.Mix(rgbBlack, ColourSpace.Hsb, premultiplyAlpha: false);
        var toRgbWhite = blue.Mix(rgbWhite, ColourSpace.Hsb, premultiplyAlpha: false);
        var toHsbBlack = blue.Mix(hsbBlack, ColourSpace.Hsb, premultiplyAlpha: false);
        var toHsbWhite = blue.Mix(hsbWhite, ColourSpace.Hsb, premultiplyAlpha: false);
    ...
    public void GreyscaleBothRgbColours()
    {
        ...
        var blackToWhite = black.Mix(white, ColourSpace.Hsb, premultiplyAlpha: false);
        var blackToGrey = black.Mix(grey, ColourSpace.Hsb, premultiplyAlpha: false);
        var whiteToGrey = white.Mix(grey, ColourSpace.Hsb, premultiplyAlpha: false);
