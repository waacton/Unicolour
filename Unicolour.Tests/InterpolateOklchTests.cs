...
public class InterpolateOklchTests
{
    ...
    {
        var unicolour1 = Unicolour.FromOklch(50, 50, 180, 0.5);
        var unicolour2 = Unicolour.FromOklch(50, 50, 180, 0.5);
    ...
    public void Equidistant()
    {
        ...
        var unicolour2 = Unicolour.FromOklch(50, 100, 180);
    ...
    public void EquidistantViaZero()
    {
        ...
        var unicolour2 = Unicolour.FromOklch(80, 50, 340, 0.2);
        var interpolated1 = unicolour1.InterpolateOklch(unicolour2, 0.5);
        var interpolated2 = unicolour2.InterpolateOklch(unicolour1, 0.5);
    ...
    {
        var unicolour1 = Unicolour.FromOklch(0, 100, 0);
        var unicolour2 = Unicolour.FromOklch(80, 0, 180, 0.5);
    ...
    {
        var unicolour1 = Unicolour.FromOklch(0, 100, 300);
        var unicolour2 = Unicolour.FromOklch(80, 0, 60, 0.5);
        var interpolated1 = unicolour1.InterpolateOklch(unicolour2, 0.75);
        var interpolated2 = unicolour2.InterpolateOklch(unicolour1, 0.75);
    ...
    {
        var unicolour1 = Unicolour.FromOklch(20, 40, 0, 0.8);
        var unicolour2 = Unicolour.FromOklch(30, 60, 90, 0.9);
