...
public static class Nord
{
    ...
    public static readonly IEnumerable<Unicolour> PolarNight = [Nord0, Nord1, Nord2, Nord3];
    public static readonly IEnumerable<Unicolour> SnowStorm = [Nord4, Nord5, Nord6];
    public static readonly IEnumerable<Unicolour> Frost = [Nord7, Nord8, Nord9, Nord10];
    public static readonly IEnumerable<Unicolour> Aurora = [Nord11, Nord12, Nord13, Nord14, Nord15];
