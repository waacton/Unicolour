...
// internal record LineSegment((double x, double y) Start, (double x, double y) End) : Line(GetSlopeAndIntercept(Start, End))
// {
//     internal (double x, double y) Start = Start;
//     internal (double x, double y) End = End;
//
//     private static (double slope, double intercept) GetSlopeAndIntercept((double x, double y) point1, (double x, double y) point2)
//     {
//         var (x1, y1) = point1;
//         var (x2, y2) = point2;
//         var sameX = x1 == x2;
