...
public class MixGreyscaleHpluvTests
{
    ...
    public void GreyscaleStartColour()
    {
        ...
        var fromRgbBlack = rgbBlack.Mix(green, ColourSpace.Hpluv, premultiplyAlpha: false);
        var fromRgbWhite = rgbWhite.Mix(green, ColourSpace.Hpluv, premultiplyAlpha: false);
        var fromHpluvBlack = hpluvBlack.Mix(green, ColourSpace.Hpluv, premultiplyAlpha: false);
        var fromHpluvWhite = hpluvWhite.Mix(green, ColourSpace.Hpluv, premultiplyAlpha: false);
    ...
    public void GreyscaleEndColour()
    {
        ...
        var toRgbBlack = blue.Mix(rgbBlack, ColourSpace.Hpluv, premultiplyAlpha: false);
        var toRgbWhite = blue.Mix(rgbWhite, ColourSpace.Hpluv, premultiplyAlpha: false);
        var toHpluvBlack = blue.Mix(hpluvBlack, ColourSpace.Hpluv, premultiplyAlpha: false);
        var toHpluvWhite = blue.Mix(hpluvWhite, ColourSpace.Hpluv, premultiplyAlpha: false);
    ...
    public void GreyscaleBothLuvColours()
    {
        ...
        var blackToWhite = black.Mix(white, ColourSpace.Hpluv, premultiplyAlpha: false);
        var blackToGrey = black.Mix(grey, ColourSpace.Hpluv, premultiplyAlpha: false);
        var whiteToGrey = white.Mix(grey, ColourSpace.Hpluv, premultiplyAlpha: false);
