...
internal static class Comparison
{
    ...
    {
        var (jz1, cz1, hz1) = reference.Jzczhz;
        var (jz2, cz2, hz2) = sample.Jzczhz;
    ...
    {
        var (j1, a1, b1) = reference.Cam02;
        var (j2, a2, b2) = sample.Cam02;
    ...
    {
        var (j1, a1, b1) = reference.Cam16;
        var (j2, a2, b2) = sample.Cam16;
