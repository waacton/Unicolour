...
public static class IctcpConfigurationTests
{
    ...
    public static void Rec2020RgbToIctcp100()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(red, new(0.396807697, -0.135943598, 0.234295237), 0.000000001);
        AssertUtils.AssertTriplet<Ictcp>(blue, new(0.323484554, 0.235351529, -0.130337248), 0.000000001);
        AssertUtils.AssertTriplet<Ictcp>(white, new(0.50808, 0, 0), 0.0005); // InverseEOTF(100) ~= 0.50808
        AssertUtils.AssertTriplet<Ictcp>(black, new(0, 0, 0), 0.0005);
        ...
        AssertUtils.AssertTriplet<Ictcp>(redNoConfig, new(0.396807697, -0.135943598, 0.234295237), 0.000000001);
        AssertUtils.AssertTriplet<Ictcp>(blueNoConfig, new(0.323484554, 0.235351529, -0.130337248), 0.000000001);
        AssertUtils.AssertTriplet<Ictcp>(whiteNoConfig, new(0.50808, 0, 0), 0.0005); // InverseEOTF(100) ~= 0.50808
    ...
    public static void Rec2020RgbToIctcp1()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(white, new(0.14995, 0, 0), 0.0005); // InverseEOTF(1) ~= 0.14995
        AssertUtils.AssertTriplet<Ictcp>(black, new(0, 0, 0), 0.0005);
    }
    ...
    public static void Rec2020RgbToIctcp203()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(white, new(0.58069, 0, 0), 0.0005); // InverseEOTF(203) ~= 0.5807
        AssertUtils.AssertTriplet<Ictcp>(black, new(0, 0, 0), 0.0005);
    }
    ...
    public static void ConvertTestColour()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(convertedTo1, new(0.07351364, 0.00475253, 0.09351596), 0.00001);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo203, new(0.39224991, -0.0001166, 0.28389029), 0.0001);
        AssertUtils.AssertTriplet(convertedTo100.Ictcp.Triplet, initial100.Ictcp.Triplet, 0.0005);
    }
    ...
    public static void ConvertWhite()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(initial100, new(0.50808, 0, 0), 0.0005);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo1, new(0.14995, 0, 0), 0.0005);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo203, new(0.58069, 0, 0), 0.0005);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo100, new(0.50808, 0, 0), 0.0005);
    }
    ...
    public static void ConvertBlack()
    {
        ...
        AssertUtils.AssertTriplet<Ictcp>(initial100, new(0, 0, 0), 0.0005);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo1, new(0, 0, 0), 0.0005);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo203, new(0, 0, 0), 0.0005);
        AssertUtils.AssertTriplet<Ictcp>(convertedTo100, new(0, 0, 0), 0.0005);
    }
}