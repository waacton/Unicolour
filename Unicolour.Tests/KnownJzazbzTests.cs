...
public class KnownJzazbzTests
{
    ...
    public void Red()
    {
        ...
        AssertUtils.AssertTriplet<Jzazbz>(red, new(0.13438, 0.11789, 0.11188), Tolerance);
    }
    ...
    public void Green()
    {
        ...
        AssertUtils.AssertTriplet<Jzazbz>(green, new(0.17681, -0.10904, 0.11899), Tolerance);
    }
    ...
    public void Blue()
    {
        ...
        AssertUtils.AssertTriplet<Jzazbz>(blue, new(0.09577, -0.04085, -0.18585), Tolerance);
    }
    ...
    public void Black()
    {
        ...
        AssertUtils.AssertTriplet<Jzazbz>(black, new(0.00000, 0.00000, 0.00000), Tolerance);
    }
    ...
    public void White()
    {
        ...
        AssertUtils.AssertTriplet<Jzazbz>(white, new(0.22207, -0.00016, -0.00012), Tolerance);
    }
}