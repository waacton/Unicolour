...
public class MixRgbTests
{
    ...
    public void SameColour()
    {
        ...
        var mixed1 = unicolour1.MixRgb(unicolour2, 0.25, false);
        var mixed2 = unicolour2.MixRgb(unicolour1, 0.75, false);
        var mixed3 = unicolour1.MixRgb(unicolour2, 0.75, false);
        var mixed4 = unicolour2.MixRgb(unicolour1, 0.25, false);
    ...
    public void Equidistant()
    {
        ...
        var mixed1 = unicolour1.MixRgb(unicolour2, 0.5, false);
        var mixed2 = unicolour2.MixRgb(unicolour1, 0.5, false);
    ...
    public void CloserToEndColour()
    {
        ...
        var mixed1 = unicolour1.MixRgb(unicolour2, 0.75, false);
        var mixed2 = unicolour2.MixRgb(unicolour1, 0.75, false);
    ...
    public void CloserToStartColour()
    {
        ...
        var unicolour2 = Unicolour.FromRgb(0.8, 0.0, 1.0, 0.5);
        var mixed1 = unicolour1.MixRgb(unicolour2, 0.25, false);
        var mixed2 = unicolour2.MixRgb(unicolour1, 0.25, false);
    ...
    public void BeyondEndColour()
    {
        ...
        var mixed1 = unicolour1.MixRgb(unicolour2, 1.5, false);
        var mixed2 = unicolour2.MixRgb(unicolour1, 1.5, false);
    ...
    {
        var unicolour1 = Unicolour.FromRgb(0, 0, 0, 0.5);
        var unicolour2 = Unicolour.FromRgb(0, 0, 0, 1.5);
        var mixed = unicolour1.MixRgb(unicolour2, 3);
    ...
    {
        var unicolour1 = Unicolour.FromRgb(0, 0, 0, 0.5);
        var unicolour2 = Unicolour.FromRgb(0, 0, 0, -0.5);
        var mixed = unicolour1.MixRgb(unicolour2, 3);
    ...
    {
        var unicolour1 = Unicolour.FromRgb(start.Triplet.Tuple, start.Alpha);
        var unicolour2 = Unicolour.FromRgb(end.Triplet.Tuple, end.Alpha);
        var mixed = unicolour1.MixRgb(unicolour2, amount, premultiplyAlpha: true);
    ...
    {
        AssertUtils.AssertMixed(unicolour.Rgb.Triplet, unicolour.Alpha.A, expected);
    }
}