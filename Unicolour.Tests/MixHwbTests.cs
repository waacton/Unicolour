...
public class MixHwbTests
{
    ...
    public void SameColour()
    {
        ...
        var mixed1 = unicolour1.MixHwb(unicolour2, 0.25, false);
        var mixed2 = unicolour2.MixHwb(unicolour1, 0.75, false);
        var mixed3 = unicolour1.MixHwb(unicolour2, 0.75, false);
        var mixed4 = unicolour2.MixHwb(unicolour1, 0.25, false);
    ...
    public void Equidistant()
    {
        ...
        var mixed1 = unicolour1.MixHwb(unicolour2, 0.5, false);
        var mixed2 = unicolour2.MixHwb(unicolour1, 0.5, false);
    ...
    public void CloserToEndColour()
    {
        ...
        var mixed1 = unicolour1.MixHwb(unicolour2, 0.75, false);
        var mixed2 = unicolour2.MixHwb(unicolour1, 0.75, false);
    ...
    public void CloserToStartColour()
    {
        ...
        var unicolour2 = Unicolour.FromHwb(180, 0, 1, 0.5);
        var mixed1 = unicolour1.MixHwb(unicolour2, 0.25, false);
        var mixed2 = unicolour2.MixHwb(unicolour1, 0.25, false);
    ...
    public void BeyondEndColour()
    {
        ...
        var mixed1 = unicolour1.MixHwb(unicolour2, 1.5, false);
        var mixed2 = unicolour2.MixHwb(unicolour1, 1.5, false);
    ...
    {
        var unicolour1 = Unicolour.FromHwb(0, 0, 0, 0.5);
        var unicolour2 = Unicolour.FromHwb(0, 0, 0, 1.5);
        var mixed = unicolour1.MixHwb(unicolour2, 3);
    ...
    {
        var unicolour1 = Unicolour.FromHwb(0, 0, 0, 0.5);
        var unicolour2 = Unicolour.FromHwb(0, 0, 0, -0.5);
        var mixed = unicolour1.MixHwb(unicolour2, 3);
    ...
    {
        var unicolour1 = Unicolour.FromHwb(start.Triplet.Tuple, start.Alpha);
        var unicolour2 = Unicolour.FromHwb(end.Triplet.Tuple, end.Alpha);
        var mixed = unicolour1.MixHwb(unicolour2, amount, premultiplyAlpha: true);
    ...
    {
        AssertUtils.AssertMixed(unicolour.Hwb.Triplet, unicolour.Alpha.A, expected);
    }
}